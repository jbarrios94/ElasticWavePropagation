...
Lim_Infx = 4000; Lim_Supx = 14000; NumVolx = c1.shape[1]
Lim_Infy = 0; Lim_Supy = 3500; NumVoly = c1.shape[0]
t_inicial = 0.; t_final = 2500
CFL = 0.25
...
isx = np.where(np.linspace(Lim_Infx, Lim_Supx, NumVolx) == 8500)[0][0]
